       ...
       # ------------------------------------------
        ...
        if not self.pca_dim:
            ...
            if len(meg_data.shape) == 3:
                ...
                nrows_Xmat_c = fftsize*nwindows
            elif  len(meg_data.shape) == 2:
                fftsize, nchan = meg_data.shape
                nrows_Xmat_c = fftsize
            
            Xmat_c = meg_data.transpose()#.reshape((nrows_Xmat_c, nchan), order='F')
            ...
            self.pca_dim = 8#pca_dim
            del Xmat_c, covmat, Ec, idx_sort, Dc, ntsl
